...
| $dashboard-trade-count | dashboard |
| $navbar | navbar |
| $nav-trading | navbar |
...
**Planner notes:** This sequence logs in as a maker, creates and submits a trade, logs out, logs in as a checker, approves the trade, and then verifies the dashboard trade count.
