...
**Planner notes:** This sequence logs in as maker, creates a buy and sell trade, logs out, logs in as checker, and then approves both pending trades, covering the user and trade creation/approval flow.
