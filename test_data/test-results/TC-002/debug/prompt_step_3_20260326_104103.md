...
Translate step **3**: "Create a sell trade for 100 AAPL  [TestData: sector=Technology,ticker=AAPL,quantity=100,accountType=Cash,timeInForce=Day Order]"

## Rules

1. Return ONLY a JSON array of step objects: `[{"tcStep": N, "action": "...", "locator": "...", "test_input": "...", "output": ""}]`.
2. Every object in the array MUST have `"tcStep": 3`.
