...
**Planner notes:** This sequence logs in as maker, creates a buy trade, logs out, logs in as checker, approves the trade, and then verifies the dashboard count, covering all high-level test steps.
